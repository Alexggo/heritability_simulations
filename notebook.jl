...
# ╔═╡ a3b053d5-d5b9-4b49-ba71-f0b48ace0c85
begin
...
# ╔═╡ 1aab09b5-503b-4414-8e3f-62896dbadb13
if env_type == "Uniform"
...
# ╔═╡ b887ec64-8bea-459e-8f78-1565717440b5
possible_num_homo = 0:(number_loci - min_num_hetero)

# ╔═╡ 90502ab0-8c82-4f77-b6d4-550967b84495
number_of_add = number_loci - number_of_dom

# ╔═╡ 74929439-f043-4ff8-b972-24adf0f7e363
add_vec = fill("ADD", number_of_add)

# ╔═╡ eb174daf-50b7-43b5-bee0-1087fc0c1014
dom_vec = fill("DOM", number_of_dom)

# ╔═╡ 069d4693-ca7e-41ea-bd76-705476a24bac
all_effect = c(add_vec, dom_vec)

# ╔═╡ 0be333c3-51e6-44da-99d5-4030569ba7c2
mid_effect = mean([effect_A1, effect_A2])

# ╔═╡ 1aa389db-1c90-4fdf-91a4-9138553e60fa
effect_a1 = effect_A1 - mid_effect

# ╔═╡ dda78717-c0ab-43dd-9ace-3467ee9387df
effect_a2 = effect_A2 - mid_effect

# ╔═╡ e3d83d6e-68f3-4bd1-8ca1-8da4db215787
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "ab8e023330e310440c2f6b4f07e0bb81c3fdf5ba"
