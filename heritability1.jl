...
@bind number_of_dom Slider(0:15,2,true)
...
@bind effect_A2 Slider(-3:3,0,true)
...
@bind env_type Select(["Uniform","Normal"])
...
@bind epistasis Select([false,true])
...
md"""
The slope is the heritability for all simulations (blue line).
...
manifest_format = "2.0"
project_hash = "85b0131611f782678ab71ed05b3381e02e23bd39"
